...
npx electron-packager . my-app --electron-version "$(electron -v)"  --platform=darwin --arch=arm64 --out=dist --overwrite  --ignore='^(?!main|node_modules|package.json|package.json|package-lock.json|.*/main|.*/node_modules|.*/package.json|.*/package.json|.*/package-lock.json)(.+)$'
